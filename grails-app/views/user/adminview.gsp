    ...
    <section id="partyView" class="main style1">
        <div class="container">
            <div class="row 150%">
                ...
                <iframe style="float: right" src="https://embed.spotify.com/?uri=spotify:user:${userId}:playlist:${playlistId}" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>
            </div>
        </div>
    </section>
</section>
